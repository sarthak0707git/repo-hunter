  ...
  return (
    <>
      <div className="panel-animate w-full rounded-md border border-[var(--border-muted)] bg-[var(--bg-tertiary)] p-5 text-left shadow-inner shadow-[var(--shadow)]/60 sm:p-6">
        ...
        <div className="mb-3">
          <p className="text-red-500">For best results select top 6-8 topics</p>
        </div>
          ...
          {topics.map((topic, idx) => {
            ...
            return (
              <span
                ...
                className={`cursor-pointer select-none rounded-full border px-3 py-1 text-sm transition-all ${
                  isSelected
